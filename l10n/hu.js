OC.L10N.register(
    ...
    "Check Auto Group membership on modification of a user's groups." : "Automatikus csoporttagságok ellenőrzése a felhasználó csoportjainak módosításakor.",
    "If checked, Auto Group membership will be re-enforced for a user account every time it is added to or removed from a group." : "Ha be van jelölve, akkor a fiók automatikus csoporttagságai újból ki lesznek kikényszerítve, ha hozzáadásra kerül egy csoporthoz, vagy eltávolítják egyből.",
