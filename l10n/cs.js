OC.L10N.register(
    ...
    "Check Auto Group membership on modification of a user's groups." : "Při změně členství uživatele ve skupinách kontrolovat automatické členství ve skupinách.",
    "If checked, Auto Group membership will be re-enforced for a user account every time it is added to or removed from a group." : "Pokud je zaškrtnuto, automatické členství ve skupinách bude znovu vynucováno při jakémkoli přidání či odebrání ze skupiny.",
